...
public class WorldAI {
    ...
    private void calculateInfluenceStep(float[][] in, float[][] out) {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if (!logic.game.worldMapState.map.walkableTile(x, y)
                        || !logic.game.worldMapState.map.sailableTile(x, y)) {
                    out[x][y] = 0;
                    continue;
                }
    ...
    void calculateInfluenceMap(Faction f) {
        ...
        // Place influence for every garrison + settlement level
        ...
        // Place influence for every army and how far they can walk
        // TODO: Also keep cargo in mind for influence?
